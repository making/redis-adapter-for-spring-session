...
/**
 * What the etcd backend is pointed at and tuned with. Nothing here applies to any other
 * backend, and none of it is read unless {@code redis-adapter.backend} asks for
 * {@value RedisAdapterProperties#ETCD_BACKEND}.
 *
 * <p>

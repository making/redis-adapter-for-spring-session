 ...
 * classes of this server, a real Lettuce client over TCP, and an etcd in a container.
 * Nothing is mocked, and the application is configured exactly as it would be against
 * Redis.
 *
 * <p>
...
@SpringBootTest(classes = EtcdBackendEndToEndTests.SessionApplication.class,
		properties = { "redis-adapter.etcd.watch-retry-delay=100ms" })
